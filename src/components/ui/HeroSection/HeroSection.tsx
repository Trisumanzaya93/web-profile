...
const handleModal = (setter: Journey, content: Array<string>) => () => {
  setter.setModalContent(content);
  ...
  return [
    {
      title: "2022",
      content: (
        <button className='w-full text-left' onClick={handleModal(setter, experiencesFazztech)}>
    ...
    },
    {
      title: "2023 - Now",
      content: (
        <button onClick={handleModal(setter, experiencesSmbc)} className='w-full text-left'>
